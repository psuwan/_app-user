...
<head>
    ...
    <link rel="icon" type="image/png" href="../_theme-01/assets/img/favicon.png">
    ...
    <!-- CSS Files -->
    <link href="../_theme-01/assets/css/bootstrap.min.css" rel="stylesheet"/>
    <link href="../_theme-01/assets/css/paper-dashboard.css?v=2.0.1" rel="stylesheet"/>
...
<div class="container">
    ...
    <div class="row mt-3">
        <div class="col-md-4 offset-md-4 text-center">
            <strong>เข้าสู่ระบบ / <a href="user-register.php" class="text-secondary"><?= $textTitle; ?></a></strong>
        </div>
    </div>
    <form action="act4-user.php" method="post">
        <div class="row mt-3 px-3">
            <div class="col-md-6 offset-md-3 bg-white" style="border-radius:5px">
                ...
                <div class="row mt-2">
                    <div class="col-md-12">
                        <select name="login_user" id="id4_select_user"
                                class="form-control form-control-sm select2-basic-single" required>
                            <option value=""></option>
                            <?php
                            $sqlcmd_listPrefix = "SELECT * FROM tbl_prefix WHERE 1";
                ...
                <div class="row mt-2 mb-5">
                    <div class="col-md-12 text-center">
                        <input type="hidden" name="userRefCode" value="<?= $userRefCode; ?>">
                        <input type="hidden" name="processName" value="regisUser">
...
<script>
    $(document).ready(function () {
        // PLUGIN SELECT2
        $('#id4_select_user').select2({
            placeholder: "ชื่อผู้ใช้งาน"
        });
        $("#id4_select_usersite").select2({
